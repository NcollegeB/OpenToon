...
# Let ShowBase derive the real aspect ratio from the window.  A fixed 4:3
# aspect ratio stretches or letterboxes widescreen resolutions.
aspect-ratio 0
sync-video #t
clock-mode limited
clock-frame-rate 60
