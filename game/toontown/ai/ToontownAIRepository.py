...
class ToontownAIRepository(ToontownInternalRepository):
    ...
    def createLocals(self):
        ...
        # Create the authoritative fishing reward and occupancy manager...
    ...
    def findFishingSpots(self, dnaData, pond):
        fishingSpots = []
        if 'fishing_spot' in dnaData.getName():
            spot = DistributedFishingSpotAI(self)
            spot.setPondDoId(pond.doId)
        ...
        for index in range(dnaData.getNumChildren()):
            fishingSpots.extend(self.findFishingSpots(dnaData.at(index), pond))
