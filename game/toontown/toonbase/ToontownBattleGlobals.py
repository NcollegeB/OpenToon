...
UnpaidMaxSkills = [Levels[0][1] - 1,
 ...
 Levels[6][1] - 1]
ExperienceCap = 200
BaseGagExperienceMultiplier = 10
...
def getBaseGagExperienceMultiplier():
    return BaseGagExperienceMultiplier


def getBuildingGagExperienceMultiplier(numFloors):
    return BaseGagExperienceMultiplier + max(0, int(numFloors))
