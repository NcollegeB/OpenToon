...
MinigameSkipButton = 'Skip Minigame'
MinigameSkipConfirm = 'Vote to skip this minigame?\nAll players must agree.'
MinigameSkipVoteSubmitted = 'Skip vote submitted'
MinigameSkipVoteStatus = 'Skip votes: %d/%d'
MinigameSkipVoteAccepted = 'Skip accepted'
...
OptionsPageMainMenu = 'Main Menu'
OptionsPageExit = 'Exit'
# Retain the legacy localizer key for compatible third-party code.
OptionsPageExitToontown = OptionsPageExit
...
OptionsPageMainMenuConfirm = 'Return to the Main Menu?'
OptionsPageExitConfirm = 'Exit the game?'
...
QuestOverlayTitle = 'Current ToonTasks'
QuestOverlayHint = 'Caps Lock or Esc to close'
QuestOverlayEmpty = 'No active ToonTasks.'
...
PatternGameHost = 'Dance Coach'
PatternGameTitle = 'Match the Dance Coach'
PatternGameInstructions = 'The Dance Coach will show you a dance sequence. Try to repeat it using the arrow keys!'
...
QuestScriptTutorialGuide_1 = 'Open Town has a new citizen! Do you have some extra gags?'
QuestScriptTutorialGuide_2 = 'Sure! Follow the tutorial guide.'
QuestScriptTutorialGuide_3 = 'The tutorial guide will tell you all about the Cogs.\x07Gotta go!'
QuestScriptTutorialGuide_4 = 'Come here! Use the movement keys to move.'
...
from otp.otpbase.NeutralBranding import neutralize_localizer
neutralize_localizer(globals())
del neutralize_localizer
