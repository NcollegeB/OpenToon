# This module implements the authoritative AI-server side of golf hole, handling validated state and
# synchronized gameplay for courses, holes, physics, scores, and rewards.
