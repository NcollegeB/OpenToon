...
from toontown.quest import QuestOverlay
...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def disable(self):
        ...
        self.questMap = None
        if self.questOverlay:
            self.questOverlay.destroy()
            self.questOverlay = None
    ...
    def initInterface(self):
        ...
        self.questOverlay = QuestOverlay.QuestOverlay(self)
