...
class InventoryNew(InventoryBase.InventoryBase, DirectFrame):
    ...
    def __init__(self, toon, invStr = None, ShowSuperGags = 1):
        ...
        self.__battleCreditMultiplier = getBaseGagExperienceMultiplier()
        self.__battleCreditMultiplierIsAbsolute = False
    ...
    def setBattleCreditMultiplier(self, mult, absolute = False):
        if absolute:
            self.__battleCreditMultiplier = mult
        else:
            self.__battleCreditMultiplier = (
                getBaseGagExperienceMultiplier() * mult)
        self.__battleCreditMultiplierIsAbsolute = absolute

    def getBattleCreditMultiplier(self):
        return self.__battleCreditMultiplier

    def battleCreditMultiplierIsAbsolute(self):
        return self.__battleCreditMultiplierIsAbsolute
