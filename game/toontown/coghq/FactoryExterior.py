# This module manages the client location lifecycle, state transitions, and interactions for factory
# exterior within Cog HQ facilities, bosses, rooms, and level entities.
