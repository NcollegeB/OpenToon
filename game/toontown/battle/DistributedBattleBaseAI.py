# This module implements the authoritative AI-server side of battle, handling validated state and
# synchronized gameplay for Cog battle rules, presentation, calculations, and rewards.
