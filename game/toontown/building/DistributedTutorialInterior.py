...
class DistributedTutorialInterior(DistributedObject.DistributedObject):
    ...
    def disable(self):
        ...
        self.sky.removeNode()
        del self.sky
        self.tutorialMovie.cleanup()
        del self.tutorialMovie
    ...
    def setup(self):
        ...
        if not npcOrigin.isEmpty():
            ...
            self.npc.clearMat()
        self.createSuit()
        self.tutorialMovie = QuestParser.NPCMoviePlayer('tutorial_guide', base.localAvatar, self.npc)
