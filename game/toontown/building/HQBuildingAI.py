# This module provides AI-server logic for HQ building, coordinating authoritative simulation and
# state for buildings, interiors, doors, elevators, and boarding.
