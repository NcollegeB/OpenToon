# This module implements the authoritative AI-server side of suit interior, handling validated state
...
class DistributedSuitInteriorAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def __createFloorBattle(self):
        ...
        mult = getBuildingGagExperienceMultiplier(self.numFloors)
        self.battle.battleCalc.setSkillCreditMultiplierAbsolute(mult)
