# This module implements the authoritative AI-server side of diving game, handling validated state
...
class DistributedDivingGameAI(DistributedMinigameAI):
    ...
    def exitSwimming(self):
        for spawning in getattr(self, 'spawnings', []):
            spawning.pause()
