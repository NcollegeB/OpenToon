# This module implements the town battle SOS interface, presenting and updating player controls and
# information for streets, town loading, place state, and street battles.
