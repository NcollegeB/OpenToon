...
def _exit_on_windows_break(signum, frame):
    raise SystemExit(0)


if hasattr(signal, 'SIGBREAK'):
    signal.signal(signal.SIGBREAK, _exit_on_windows_break)

parser = argparse.ArgumentParser(description="Open Town - UberDOG Server")
