# This module creates the authoritative zones and distributed objects for the oz neighborhood.
...
class OZHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def startup(self):
        ...
        if (self.air.config.GetBool('want-classic-characters', 0) and
                self.air.config.GetBool('create-chip-and-dale', 1)):
