# This module provides AI-server logic for Lawbot HQ data, coordinating authoritative simulation and
# state for neighborhoods, zone data, and neighborhood lifecycle.
