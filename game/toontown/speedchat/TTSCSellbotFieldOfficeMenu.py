# This module implements the SpeedChat Sellbot field office interface, presenting and updating
# player controls and information for SpeedChat menus, terminals, phrases, and decoding.
